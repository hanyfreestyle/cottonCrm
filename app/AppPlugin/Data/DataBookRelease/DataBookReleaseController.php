...
namespace App\AppPlugin\Data\DataBookRelease;
...
class DataBookReleaseController extends AdminMainController {

    use ConfigDataTraits;

    function __construct(ConfigData $model, ConfigDataTranslation $modelTranslation) {
        parent::__construct();
        $this->controllerName = "BookRelease";
        $this->cat_id = "BookRelease";
        $this->PrefixRole = 'data';
        $this->selMenu = "admin.data.";
        $this->PrefixCatRoute = "";
        $this->PageTitle = __('admin/data/BookRelease.app_menu');
