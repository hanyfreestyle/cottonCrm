...
Route::get('/book/AddReleaseYears/{id}', [PeriodicalsReleaseController::class, 'AddReleaseYears'])->name('Periodicals.AddReleaseYears');
Route::post('/book/AddYearReleaseForm/{cat_id}', [PeriodicalsReleaseController::class, 'AddYearReleaseForm'])->name('Periodicals.AddYearReleaseForm');

Route::get('/book/deleteAllRelease/{id}', [PeriodicalsReleaseController::class, 'deleteAllRelease'])->name('Periodicals.deleteAllRelease');
Route::post('/book/deleteAllReleaseConfirm/{id}', [PeriodicalsReleaseController::class, 'deleteAllReleaseConfirm'])->name('Periodicals.deleteAllReleaseConfirm');
