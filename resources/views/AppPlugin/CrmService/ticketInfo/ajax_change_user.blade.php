<div class="row infoDiv">
    ...
    <div class="col-lg-12">
        <form action="{{route('admin.TicketOpen.changeUserUpdate' ,$ticket->id)}}" method="post">
            @csrf
            <x-app-plugin.crm-service.leads.user-select type="changeUser" :row="$ticket" col="12" :col-mobile="12" :labelview="false" :req="false"/>
