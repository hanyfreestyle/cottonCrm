...
@section('content')
    ...
    <x-admin.hmtl.section>
        ...
        <div class="row mb-5 pb-5">
            <x-admin.report.session-chart id="TypeId" :l="__($defLang.'var_customer_type_id')" i="fas fa-business-time" key="type_id" />
            <x-admin.report.session-chart id="Evaluation" :l="__($defLang.'report_evaluation')" i="fas fa-star" key="evaluation_id" />
